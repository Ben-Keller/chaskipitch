...
const regionOptions = ["all", "africa", "asia", "latin_america"];

export function CountryExplorer({ countries, onCountrySelect }) {
        ...
        {filtered.map((country) => (
          <article className="panel" key={country.iso3}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <SourcePill page={Array.isArray(country.metrics.source_page) ? country.metrics.source_page[0] : country.metrics.source_page} />
            </div>
          </article>
        ))}
      </section>

...
const fallbackGeoCollection = {
  type: "FeatureCollection",
  features: []
};

const fallbackCountryVideoIndex = {
  by_iso3: {},
  global_recent: []
};

const fallbackCountryEvidence = {
  iso3: "",
  structured_kpis: [],
...
const fallbackPhotoAssignments = {
  country_photos: {},
  theme_media: {}
};
...
function buildCountryKpis(country) {
  if (!country) {
    return [];
  }
...
function buildCountryVideos(country, countryVideoIndex) {
  if (!country) {
    return [];
  }
...
function buildEvidenceKpis(evidence) {
...
function buildEvidenceExcerpts(evidence) {
...
function buildEvidenceHighlights(evidence) {
...
function AtlasContextPhoto({ src, alt, fallbackSrc = "" }) {
